...
def done():
    ...
    queues_empty = not cycles.Execute_Queue and not cycles.Ready_Queue \
                   and not cycles.Waiting_Queue and not cycles.Result_Queue \
                   and not CDB.CDB_Queue

    return no_more_insts and all_adders_free and all_mults_free and all_loads_free and all_stores_free and queues_empty
